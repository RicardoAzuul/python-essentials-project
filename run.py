...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figurate subtracted from the stock:
    ...
    surplus_data = []
    # zip method allows iterating thru 2 or more lists at the same time
...
def get_last_5_entries_sales():
    ...
    for index in range(1, 7):
        ...
        columns.append(column[-5:])  # we just need the last 5 entries
...
def get_stock_values(data):
    """
    Get stock values of sandwiches to be made for next day
    """
    headings = []
